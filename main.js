...
let splashhide = document.querySelector(".splash");
//splash screen
setTimeout(function () {
    splash.classList.add("deactive"); //move splash screen upwards
}, 1500);
setTimeout(function () {
    splashhide.style.display = "none"; // hide splash screen after 2.5sec
}, 2500);
...
imgbtn1.addEventListener("click", function () {
    ...
    imgtext.innerHTML = "In the adult stage of a chicken's life cycle, the bird reaches full maturity. This usually happens around 5 to 6 months of age. Adult hens begin to lay eggs regularly, while roosters develop larger combs, wattles, and start crowing loudly. Adult chickens spend their time foraging, scratching the ground for food, dust bathing, and socializing with other chickens. They can reproduce at this stage, starting the life cycle again through egg-laying and fertilization. Most adult chickens can live for several years, depending on their environment and care.";
});
imgbtn2.addEventListener("click", function () {
    popsound.play();
    imgheader.style.color = 'darkorange';
    imgheader.innerHTML = "Baby Chick";
    imgtext.innerHTML = "The chick stage is the second stage of a chicken's life cycle, right after hatching from the egg. After about 21 days of incubation, the chick breaks out of the shell using its tiny egg tooth. Chicks are covered in soft, fluffy down feathers and are very small and fragile. They rely on warmth, either from a brooding hen or a heat source, to survive. During this stage, chicks begin eating and drinking on their own, learning to peck at food. As they grow, they start to grow adult feathers, preparing for the next stage of their life cycle—the juvenile stage.";
});
imgbtn3.addEventListener("click", function () {
    popsound.play();
    imgheader.style.color = 'darkgreen';
    imgheader.innerHTML = "The Egg";
    imgtext.innerHTML = "The egg is the first stage of a chicken's life cycle. It forms inside the hen and takes about 24 to 26 hours to fully develop before being laid. If fertilized by a rooster, the egg can develop into a chick. The egg has a hard shell that protects the growing embryo inside. During incubation, which lasts about 21 days, the embryo grows, feeding on the nutrients from the egg yolk and white. As the chick grows, it uses its egg tooth to break the shell and hatch, beginning its life outside the egg.";
});
...
function moveSprite() {
    const allAdults = document.querySelectorAll(".adult"); // get all elements with class adult
...
removebtn.addEventListener("click", function () {
    const allAdults = document.querySelectorAll(".adult");
